...
export const products = [
  {
    ...
    features: ['Type 1, 1+2 & 2 Protection', 'LED Status Indicators', 'Remote Monitoring', 'Compact Design'],
...
export const mersenBenefits = [
  { icon: FaAward, title: 'Trusted Partner', desc: 'Pavana Powers is proud to be an authorised channel partner of Mersen.' },
  { icon: FaBolt, title: 'Premium Products', desc: "Access to Mersen's industry-leading SPD, GMD, and fuse solutions." },
  { icon: FaShieldHalved, title: 'Quality Assured', desc: "Products backed by Mersen's expertise and global reputation." },
  { icon: FaBullseye, title: 'Technical Expertise', desc: 'Combined knowledge to deliver the right solutions for your needs.' },
];
...
export const industries = [
  ...
  { name: 'IT & Data Centers', icon: FaServer },
  { name: 'Healthcare', icon: FaHeartPulse },
  { name: 'Renewable Energy', icon: FaSun },
  { name: 'EV Charging Infrastructure', icon: FaCar },
  { name: 'Manufacturing', icon: FaGear },
  { name: 'Infrastructure & Construction', icon: FaHelmetSafety },
  { name: 'OEM & Panel Builders', icon: FaBriefcase },
  { name: 'Government & Public Projects', icon: FaLandmark },
];
