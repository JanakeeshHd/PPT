...
export default function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-5rem)] overflow-hidden flex items-center py-16 lg:py-20 bg-mesh">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full text-center">
        <div className="inline-flex items-center gap-3 px-7 py-4 rounded-full glass-dark border border-sky-500/30 mb-8">
